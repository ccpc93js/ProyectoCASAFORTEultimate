...
export const register = (name, nit, email, password,tDocument,department,city,adress,tel,cel,tipoClient) => async (dispatch) => {
  dispatch({ type: USER_REGISTER_REQUEST, payload: { nit, email, password,tDocument,department,city,adress,tel,cel,tipoClient } });
  try {
